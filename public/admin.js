...
function editContent(collection,record={}){
  ...
  const translatable=new Set(['title','subtitle','eyebrow','intro','body','tag','methods','role','qualifications','details','reviewsTitle','reviewsIntro','city','hours','saturday','payment','acute','heroAlt','teamImageAlt','source','monday','tuesday','wednesday','thursday','friday','saturdayHours','sunday']);
