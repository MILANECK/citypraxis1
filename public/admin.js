...
const fields={
  ...
  team:[['title','Name'],['role','Fachrichtung'],['qualifications','Qualifikationen','textarea'],['body','Biografie','textarea'],['phone','Telefon'],['email','E-Mail','email'],['image','Teamfoto (leere Auswahl entfernt das Foto)','media-image'],['placeholder','Foto ist ein Platzhalter','checkbox'],['fictional','Fiktives Beispielprofil','checkbox']],
...
function editContent(collection,record={}){
  ...
  const translatable=new Set(['title','subtitle','eyebrow','intro','body','tag','methods','role','qualifications','details','category','duration','reviewsTitle','reviewsIntro','city','hours','saturday','payment','acute','heroAlt','teamImageAlt','source','monday','tuesday','wednesday','thursday','friday','saturdayHours','sunday']);
