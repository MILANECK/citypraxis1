...
try{
  ...
  await page.locator('#editor-dialog [name=cardGivenName]').fill('Isabella');
  await page.locator('#editor-dialog [name=cardSurname]').fill('CASNY');
  await page.locator('#editor-dialog [name=cardGivenWeight]').selectOption('400');
  await page.locator('#editor-dialog [name=cardSurnameWeight]').selectOption('800');
  assert.equal(await page.locator('.team-card-type-preview').innerText(),'Isabella CASNY');
  ...
  assert.equal(await page.locator('.team-directory .team-person').first().locator('.team-surname').evaluate(el=>getComputedStyle(el).fontWeight),'800');
  ...
  assert.equal(await page.locator('#editor-dialog [name=cardSurname]').inputValue(),'CASNY');
  assert.equal(await page.locator('#editor-dialog [name=cardSurnameWeight]').inputValue(),'800');
  assert.equal(await page.locator('#editor-dialog [name=bookable]').isChecked(),false);
  await page.locator('#editor-dialog [name=cardGivenName]').fill('');
  await page.locator('#editor-dialog [name=cardSurname]').fill('');
  await page.locator('#editor-dialog [name=cardGivenWeight]').selectOption('300');
  await page.locator('#editor-dialog [name=cardSurnameWeight]').selectOption('900');
