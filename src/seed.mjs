const appointmentConcerns=[{title:'Kiefer',titleEn:'Jaw'},{title:'Kopf & Migräne',titleEn:'Headaches & migraine'},{title:'Tinnitus',titleEn:'Tinnitus'},{title:'Schwindel',titleEn:'Dizziness'},{title:'Unfall & OP',titleEn:'Injury & surgery'},{title:'Andere Beschwerden',titleEn:'Other concern',custom:true}];
...
export const seed = {
  ...
  services: [
    ...
    { id: 'heilmassage', title: 'Heilmassage', tag: 'ZEIT ZUM LOSLASSEN', intro: 'Gezielte Berührung, bewusst Zeit für Ihren Körper. Die Behandlung wird auf Ihre Bedürfnisse und den Befund abgestimmt.', body: 'Wir besprechen vorab, welche Massageform für Sie geeignet ist. Bitte klären Sie die erforderliche Verordnung vor Ihrem ersten Termin.', methods: 'Klassische Heilmassage|Individuell abgestimmte Behandlung von Muskelregionen.\nManuelle Lymphdrainage|Eine sanfte Behandlungsmethode nach entsprechender Abklärung und Verordnung.' },
    { id: 'rueckenfit', title: 'Rückenfit', tag: 'AKTIV IM ALLTAG', intro: 'Bewegung, die bleibt. Lernen Sie Übungen für einen aktiven Rücken und nehmen Sie neue Impulse mit in Ihren Alltag.', body: 'Informationen zu aktuellen Kursen, Terminen und Preisen erhalten Sie direkt bei unserer Praxis. Wir helfen Ihnen gerne bei der Auswahl des passenden Angebots.', methods: 'Bewegung in der Gruppe|Gemeinsam üben und Bewegungsabläufe kennenlernen.\nÜbungen für zu Hause|Alltagstaugliche Impulse für regelmäßige Bewegung.' }
  ],
  faqs: [
  ...
  team: [], reviews: [], prices: [], reimbursements: []
};
